        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"  style = "text-align:center">ECUST Campus Card Lost And Found</h3>
                </div>
                <div class="panel-body">
                    <form role="form" onsubmit = "return validation_check(this)"
                               action="${pageContext.request.contextPath}/login" method="post">
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control" placeholder="学号" name="studentId" autofocus>
                            </div>
...
<script type = "text/javascript">
  function validation_check(form){
	  var reg=/^[A-Z]{1}\d{8}$/;  
	  var studentId = form.studentId.value;
	  var result = studentId.match(reg);
